  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel"> 
    ...
    <div class="carousel-inner">
      <div class="item item_det active">
        <img style="width:40em; height:25em;" class="item_img" id="item_img" src="<?php echo base_url().'uploads/parts/'.$data_item_details->picture; ?>" alt="">
      </div>

      <div class="item item_det">
        <img style="width:40em; height:25em;" class="item_img" id="item_img" src="<?php echo base_url().'uploads/parts/'.$data_item_details->pictureTwo; ?>" alt="">
      </div>
    
      <div class="item item_det">
        <img style="width:40em; height:25em;" class="item_img" id="item_img" src="<?php echo base_url().'uploads/parts/'.$data_item_details->pictureThree; ?>" alt="">
      </div>
    </div>
...
<h3><?php echo $data_item_details->brand.' '.$data_item_details->model_name; ?></h3>
    <p class="date_post">Date Posted: <?php echo $data_item_details->post_date; ?></p>
    <div>
    <h2 class="item_price" id="item_price"><span style="font-size:42px;">&#8369;</span> <?php echo number_format($data_item_details->price_range,2); ?></h2>
...
<div class="header-table">Item Specifications for <?php echo $data_item_details->brand.' '.$data_item_details->model_name; ?></div>     
  <table cellspacing="0">
    <tbody>
      <tr>
        <td><img src="<?php echo base_url()."icons/price-tag.png" ?>"> Price</td>
        <td><?php echo '<span style="font-size:17px;">&#8369;</span> '.number_format($data_item_details->price_range, 2).''; ?></td>
      </tr>
      <tr>
        <td><img src="<?php echo base_url()."icons/wand.png" ?>"> Model Name</td>
        <td><?php echo $data_item_details->model_name; ?></td>
      </tr>
      <tr>
        <td><img src="<?php echo base_url()."icons/head.png" ?>"> Brand</td>
        <td><?php echo $data_item_details->brand; ?></td>
      </tr>
      <tr>
        <td><img src="<?php echo base_url()."icons/appointment.png" ?>"> Parts Category</td>
        <td><?php echo $data_item_details->parts_category; ?></td>
      </tr>
      <tr>
        <td><img src="<?php echo base_url()."icons/crayon.png" ?>"> Color</td>
        <td><?php echo $data_item_details->color; ?></td>
      </tr>
        <td><img src="<?php echo base_url()."icons/recommendation.png" ?>"> Note</td>
        ...
        <td><img src="<?php echo base_url()."icons/notepad.png" ?>"> Description</td>
        <td><?php echo $data_item_details->desc; ?></td>
      </tr>
    </tbody>
  </table>
</div>
...
<div class='container container_rating'>
  ...
  <form method="post">  
  <input type="hidden" name="id" id="id" value="<?php echo $data_item_details->sellparts_id; ?>">
...
<script type="text/javascript">
  ...
  $('.ratings').rating(function(vote,event){
   ...
   $('#submit').click(function(e) {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>index.php/dbProcess/add_rating_part",
